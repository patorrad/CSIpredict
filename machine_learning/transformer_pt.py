...
from utils import (load_and_partition_data, load_and_partition_RF_data, make_datasets, move_to_device,
...
def main() -> None:
    ...
    sequences, num_features = load_and_partition_RF_data("data.npz")
