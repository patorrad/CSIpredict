"""
Model Inputs: csi_mags, cos(theta), sin(theta)
"""
import datetime
import h5py
import numpy as np
...
for scaler_type in ['quantiletransformer-gaussian']:
    ...
    dataset_mag_rays_aoas = d.paths_to_dataset_mag_weighted_aoas_trig(paths) # will use the scaled mag data and attach the number of ray hits, scaled by 1/100
